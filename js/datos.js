let datos = document.querySelector('#datosCriosos');
let Boton = document.querySelector('#btn-Datos');
const nuevoDato = [ 
...
Boton.addEventListener('click',function(){
  const indiceAleatorio = Math.floor(Math.random() * nuevoDato.length);
  datos.innerText = nuevoDato[indiceAleatorio];
});
